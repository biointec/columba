...
You will need to rebuild the index (see [Building the index](../README.md#building-the-index)).
...
| minU (ILP)                | multiple_opt/individual_schemes/scheme_\<x>  |

Note that for the minU schemes, the average value was reported over the co-optimal schemes in the respective directory (i.e. by iterating over the different values of \<x> and taking the average of the reported values).
